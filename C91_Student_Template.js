...
function car1_up()
{
	...
	{
		car1_y=car1_y - 10;
		console.log("When up arrow pressed,  x=" + car1_x " 1 y ="+ car1_y);
		uploadBackground()
		uploadcar1()
		uploadcar2()
	}
...
function car1_down()
{
	...
	{
		car1_y=car1_y + 10;
		console.log("When down arrow pressed,  x=" + car1_x " 1 y ="+ car1_y);
		uploadBackground()
		uploadcar1()
		uploadcar2()
	}
...
function car1_left()
{
	...
	{
		car1_x=car1_x - 10;
		console.log("When left arrow pressed,  x=" + car1_x " 1 y ="+ car1_y);
		uploadBackground()
		uploadcar1()
		uploadcar2()
	}
...
function car1_right()
{
	...
	{
		car1_y=car1_y + 10;
		console.log("When right arrow pressed,  x=" + car1_x " 1 y ="+ car1_y);
		uploadBackground()
		uploadcar1()
		uploadcar2()
	}
